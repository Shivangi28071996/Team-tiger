...
newSub(a){
  ...
  // console.log(this.sign.id);
   this.prop=new SubmitDetails(a.ownername,a.email,a.propStatus,a.type,a.rooms,a.bathroom,
         a.title,a.price,a.area,a.address,a.postalcode,a.phone,a.info,a.parking,a.ac,a.sit,a.pool,a.window,a.alarm,a.heating,a.gym,a.laundry,1)
  
  this.service.post1(this.prop,this.sign.id).subscribe(t => {console.log(t),this.ngOnInit});
